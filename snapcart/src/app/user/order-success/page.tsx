...
import { CheckCircle, CheckIcon, Package } from 'lucide-react'
import Link from 'next/link'
function OrderSuccess() {
  return (
    <div className='flex flex-col items-center justify-center min-h-[80vh] px-6 
    text-center bg-linear-to-b from-green-50 to-white'>
    <motion.div
    ...
    transition={{duration:0.4, delay:0.6}}>
      ...
      You can track its progress in your <span className='font-semibold text-green-700'>My Orders</span>
    </motion.p>
    <motion.div
